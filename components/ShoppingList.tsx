  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      <div className="flex items-center justify-between px-2 gap-2">
        <h2 className="text-lg font-bold text-slate-700 dark:text-slate-200">{translations[language]?.myList || 'Mi Lista'}</h2>
      ...
      <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 border border-slate-100 dark:border-slate-800 flex justify-between items-center sticky top-0 z-10 backdrop-blur-md bg-white/90 dark:bg-slate-900/90">
        <div>
          <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase tracking-tighter">{translations[language]?.estimatedTotal || 'Total Estimado'}</p>
          <p className="text-3xl font-black text-slate-800 dark:text-white tracking-tight">${totalCost.toFixed(2)}</p>
        </div>
        <div className="text-right">
          <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase tracking-tighter">{translations[language]?.bought || 'Comprado'}</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        className={`w-7 h-7 shrink-0 rounded-xl border-2 flex items-center justify-center mr-4 transition-all ${item.checked
