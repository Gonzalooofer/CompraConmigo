              ...
              <div className="flex flex-col space-y-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-sm font-bold text-slate-700 dark:text-slate-200">2FA (Autenticador)</span>
                      <p className="text-[10px] text-slate-400 font-medium">Mayor seguridad para tu cuenta</p>
                    </div>
                  </div>
                  <button
                  ...
                  {[
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        // Optional: trigger a real translation reload if system supports it
                      }}
