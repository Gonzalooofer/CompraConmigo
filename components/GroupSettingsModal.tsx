...
import { X, Trash2, Crown, Shield, User as UserIcon, Save, AlertTriangle } from 'lucide-react';
                  ...
                  <div key={member.id} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 dark:text-slate-500">{member.email || 'Miembro'}</p>
                      </div>
                    </div>
