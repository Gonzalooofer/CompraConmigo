...
import { User as UserIcon, Menu, Settings2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleLogin = (email: string, password?: string) => {
    // Check if user exists in mock data (e.g. for demo purposes)
    let user = users.find(u => u.email === email || (email.includes('demo') && u.id === 'u1'));
