...
export const verifyLoginCode = (email: string, code: string, rememberMe?: boolean) =>
  request('/auth/verify-login', { method: 'POST', body: JSON.stringify({ email, code, rememberMe }) });
